---
layout: post
title:  Android| FCM을 이용한 Android Push 구현하기 01
date:   2017-12-19
...
> 해당 부분은 ([FCM을 이용한 Android Push 구현하기 02]) 에서 자세히 확인!
...
FirebaseInstanceId.getInstance().getToken(); 여기서 얻어오는 토큰값이 없을 경우에는 MyFirebaseInstanceIDService에서 토큰을 재생성합니다.
<br><br><br><br>
...
[FCM을 이용한 Android Push 구현하기 02]: https://stonybean.github.io/02-FCM/

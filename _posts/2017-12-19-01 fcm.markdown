...
> 해당 부분은 ([Advanced REST client를 이용한 안드로이드 푸쉬 테스트]) 에서 자세히 확인!
...
하여 Advanced REST client(ARC)를 이용해 푸쉬 테스트를 해보려 합니다.<br>
([Advanced REST client를 이용한 안드로이드 푸쉬 테스트])
...
=======
전체 소스는 [여기]서 확인하실 수 있습니다.
>>>>>>> 8863e0916191f8b6c6037170174921060a94d39e
